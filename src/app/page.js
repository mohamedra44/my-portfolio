...
export default function Home() {
  return (
    <>
      <div className="home edges max-w-7xl flex flex-col items-center min-h-[calc(100vh-120px)] justify-between mt-6 text-3xl border border-black rounded-2xl xl:mx-auto">
        ...
        <div className="relative">
          ...
          />
          <div className="w-50 backdrop-blur-sm absolute bottom-2 left-1/2 -translate-x-1/2  px-2 py-3 rounded-2xl flex justify-start items-center border border-black">
            <Link
              href={"/About"}
              className="px-2 py-1 bg-second rounded-2xl text-white text-2xl"
            >
              About Me
            </Link>
          </div>
        ...
        <div className="flex flex-col justify-center items-center m-5">
          <div className="flex flex-row justify-center items-center">
            ...
            <p className="w-fit border border-black px-2 py-1 rounded-2xl">
              A{" "}
              <span className="text-second font-bold">Software Developer</span>{" "}
